...
internal static class HostingExtensionsQuickstarts123
{
    public static WebApplication ConfigureServicesQuickstarts123(this WebApplicationBuilder builder)
    {
        // Quickstart 2 (add UI)
    ...
    public static WebApplication ConfigurePipelineQuickstarts123(this WebApplication app)
    { 
